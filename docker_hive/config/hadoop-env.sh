...
#export HADDOP_INSTALL=$HADOOP_HOME
#export HADDOP_MAPRED_HOME=$HADOOP_HOME
#export HADDOP_COMMON_HOME=$HADOOP_HOME
#export HADDOP_HDFS_HOME=$HADOOP_HOME
#export HADDOP_YARN_HOME=$HADOOP_HOME
export HADDOP_COMMON_LIB_NATIVE_DIR=$HADOOP_HOME/lib/native
export HADOOP_OPTS="-Djava.library.path=$HADDOP_COMMON_LIB_NATIVE_DIR"
...
#export PATH=$HBASE_HOME/bin:$HIVE_HOME/bin:$HADOOP_HOME/sbin:$HADOOP_HOME/bin:$PATH
